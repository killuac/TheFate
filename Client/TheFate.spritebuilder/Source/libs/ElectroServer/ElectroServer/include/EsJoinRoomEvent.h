...
@private
	...
	BOOL pluginHandles_set_;
	NSMutableArray* pluginHandles_;
}
 ...
 */
@property(strong,nonatomic) NSMutableArray* roomVariables;
/**
 * A list of plugins attached to this room.
 */
@property(strong,nonatomic) NSMutableArray* pluginHandles;

...
@property (nonatomic, strong, getter=zoneName, setter=setZoneName:) NSString * zoneName;
...
@property (nonatomic, strong, getter=plugins, setter=setPlugins:) NSArray * plugins;
@property (nonatomic, strong, getter=variables, setter=setVariables:) NSArray * variables;
...
@property (nonatomic, strong, getter=languageFilterName, setter=setLanguageFilterName:) NSString * languageFilterName;
...
@property (nonatomic, strong, getter=floodingFilterName, setter=setFloodingFilterName:) NSString * floodingFilterName;

...
@property (nonatomic, strong, getter=sharedSecret, setter=setSharedSecret:) NSString * sharedSecret;
@property (nonatomic, strong, getter=esObject, setter=setEsObject:) ThriftFlattenedEsObjectRO * esObject;
@property (nonatomic, strong, getter=userVariables, setter=setUserVariables:) NSDictionary * userVariables;
...
@property (nonatomic, strong, getter=clientVersion, setter=setClientVersion:) NSString * clientVersion;
@property (nonatomic, strong, getter=clientType, setter=setClientType:) NSString * clientType;
@property (nonatomic, strong, getter=remoteAddress, setter=setRemoteAddress:) NSArray * remoteAddress;
#endif

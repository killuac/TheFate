...
@property (nonatomic, strong, getter=userVariables, setter=setUserVariables:) NSArray * userVariables;
@property (nonatomic, getter=sendingVideo, setter=setSendingVideo:) BOOL sendingVideo;
@property (nonatomic, strong, getter=videoStreamName, setter=setVideoStreamName:) NSString * videoStreamName;

...
@property (nonatomic, strong, getter=protocolConfiguration, setter=setProtocolConfiguration:) ThriftProtocolConfiguration * protocolConfiguration;
@property (nonatomic, strong, getter=serverVersion, setter=setServerVersion:) NSString * serverVersion;
#endif

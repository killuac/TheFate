...
@property (nonatomic, strong, getter=gameType, setter=setGameType:) NSString * gameType;
...
@property (nonatomic, strong, getter=gameDetails, setter=setGameDetails:) ThriftFlattenedEsObject * gameDetails;
@property (nonatomic, strong, getter=criteria, setter=setCriteria:) ThriftSearchCriteria * criteria;
#endif

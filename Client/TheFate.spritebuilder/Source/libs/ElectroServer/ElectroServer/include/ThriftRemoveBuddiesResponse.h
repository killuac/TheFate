...
@property (nonatomic, strong, getter=buddiesRemoved, setter=setBuddiesRemoved:) NSArray * buddiesRemoved;
@property (nonatomic, strong, getter=buddiesNotRemoved, setter=setBuddiesNotRemoved:) NSArray * buddiesNotRemoved;
#endif

...
- (void) fromThrift: (id) thriftObject {
	...
	if ([t userVariablesIsSet] && t.userVariables != nil) {
		...
		for (NSString* _tKeyVar_0 in t.userVariables) {
			...
			EsObject* _valVar_0;
			_valVar_0 = [EsThriftUtil unflattenEsObject:[[EsFlattenedEsObject alloc] initWithThriftObject:_tValVar_0]];
...
- (ThriftGetUserVariablesResponse*) toThrift {
	ThriftGetUserVariablesResponse* _t = [[ThriftGetUserVariablesResponse alloc] init];;

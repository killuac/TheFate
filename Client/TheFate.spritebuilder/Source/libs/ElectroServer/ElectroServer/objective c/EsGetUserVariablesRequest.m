...
- (void) fromThrift: (id) thriftObject {
	...
	if ([t userVariableNamesIsSet] && t.userVariableNames != nil) {
		self.userVariableNames = [[NSMutableSet alloc] init];
...
- (ThriftGetUserVariablesRequest*) toThrift {
	ThriftGetUserVariablesRequest* _t = [[ThriftGetUserVariablesRequest alloc] init];;
	...
	if (userVariableNames_set_ && userVariableNames_ != nil) {
		...
		_userVariableNames = [[NSMutableSet alloc] init];
...
- (void) setUserVariableNames: (NSMutableSet*) userVariableNames {
	userVariableNames_ = userVariableNames;

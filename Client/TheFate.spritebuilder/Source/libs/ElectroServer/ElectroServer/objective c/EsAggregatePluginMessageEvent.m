...
- (void) fromThrift: (id) thriftObject {
	...
	if ([t esObjectsIsSet] && t.esObjects != nil) {
		self.esObjects = [[NSMutableArray alloc] init];
		for (ThriftFlattenedEsObjectRO* _tValVar_0 in t.esObjects) {
			EsObject* _listDestVar_0;
			_listDestVar_0 = [EsThriftUtil unflattenEsObjectRO:[[EsFlattenedEsObjectRO alloc] initWithThriftObject:_tValVar_0]];
...
- (ThriftAggregatePluginMessageEvent*) toThrift {
	ThriftAggregatePluginMessageEvent* _t = [[ThriftAggregatePluginMessageEvent alloc] init];;
	...
	if (esObjects_set_ && esObjects_ != nil) {
		...
		_esObjects = [[NSMutableArray alloc] init];

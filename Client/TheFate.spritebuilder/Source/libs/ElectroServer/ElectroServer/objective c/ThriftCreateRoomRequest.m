...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __plugins = [decoder decodeObjectForKey: @"plugins"];
    __plugins_isset = YES;
  }
  if ([decoder containsValueForKey: @"variables"])
  {
    __variables = [decoder decodeObjectForKey: @"variables"];
    __variables_isset = YES;
  }
  ...
  {
    __languageFilterName = [decoder decodeObjectForKey: @"languageFilterName"];
    __languageFilterName_isset = YES;
  }
  ...
  {
    __floodingFilterName = [decoder decodeObjectForKey: @"floodingFilterName"];
    __floodingFilterName_isset = YES;
  }
  ...
  if (__plugins_isset) {
    if (__plugins != nil) {
      [outProtocol writeFieldBeginWithName: @"plugins" type: TType_LIST fieldID: 18];
      {
        ...
        for (NSUInteger i7 = 0; i7 < [__plugins count]; i7++)
        {
  ...
  if (__variables_isset) {
    if (__variables != nil) {
      [outProtocol writeFieldBeginWithName: @"variables" type: TType_LIST fieldID: 19];
      {
        ...
        for (NSUInteger i9 = 0; i9 < [__variables count]; i9++)
        {

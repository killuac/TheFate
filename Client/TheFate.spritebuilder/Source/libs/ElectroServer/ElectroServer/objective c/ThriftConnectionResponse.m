...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __protocolConfiguration = [decoder decodeObjectForKey: @"protocolConfiguration"];
    __protocolConfiguration_isset = YES;
  }
  if ([decoder containsValueForKey: @"serverVersion"])
  {
    __serverVersion = [decoder decodeObjectForKey: @"serverVersion"];
    __serverVersion_isset = YES;
  }
  return self;
}
...
- (ThriftProtocolConfiguration *) protocolConfiguration {
  return __protocolConfiguration;
}

...
- (void) fromThrift: (id) thriftObject {
	...
	if ([t gameDetailsIsSet] && t.gameDetails != nil) {
		self.gameDetails = [EsThriftUtil unflattenEsObjectRO:[[EsFlattenedEsObjectRO alloc] initWithThriftObject:t.gameDetails]];
	}
}

- (ThriftCreateOrJoinGameResponse*) toThrift {
	ThriftCreateOrJoinGameResponse* _t = [[ThriftCreateOrJoinGameResponse alloc] init];;
	if (successful_set_) {
		BOOL _successful;

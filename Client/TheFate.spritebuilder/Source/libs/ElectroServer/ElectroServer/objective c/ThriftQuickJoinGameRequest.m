...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __gameType = [decoder decodeObjectForKey: @"gameType"];
    __gameType_isset = YES;
  }
  ...
  {
    __gameDetails = [decoder decodeObjectForKey: @"gameDetails"];
    __gameDetails_isset = YES;
  }
  if ([decoder containsValueForKey: @"criteria"])
  {
    __criteria = [decoder decodeObjectForKey: @"criteria"];
    __criteria_isset = YES;
  }
  return self;
}
